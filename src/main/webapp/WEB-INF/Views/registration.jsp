 ...
 <div class="panel panel-primary">
  ...
  <form:form action="savecustomer" method="post" modelAttribute="customer">
   <div class="col-sm-4"  >
    ...
    <form:label path="user.password">Confirm Password</form:label> <br>
    <form:input type="password"  id="txtConfirmPassword" path="user.password"   class="form-control"  />
   ...
   <h4><b>  Billing Address : </b></h4> <br> <br>  
    ...
    <input type="submit" value="Sign-Up"  onclick="return Validate()" class="btn btn-danger" style="margin-left:420px ; margin-top:30px" />
